...
export default function SkeletonContentFav(props) {
  ...
  return (
    <div
      className="w-3/4 h-72 flex flex-row mb-6 mr-8  bg-bg-white-200 rounded-md shadow-xl"
      id={props.article_id}
    >
      <div className="flex flex-col h-full w-2/3" id="container-content">
        ...
        <a
          href={props.link}
          className="text-2xl font-thin hover:underline ml-6 mt-3">
          {props.title}
        </a>
      ...
      <div
        className="h-full w-1/3 flex items-center place-content-center"
        id="container-img-card"
      >
        <h1>Img Card</h1>
      </div>
    </div>
